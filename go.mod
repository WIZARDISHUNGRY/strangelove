module jonwillia.ms/strangelove

go 1.18

require (
	bitbucket.org/dtolpin/gosparkline v0.1.0 // indirect
	github.com/Eraac/gbfs v0.0.0-20200518174807-3e6c5b1c3d08 // indirect
...
replace github.com/Eraac/gbfs => ../gbfs
